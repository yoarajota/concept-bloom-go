# Working log — Bloom filter pre-check in Go sync.Map: crossover point for miss latency under read-heavy load
...
<!-- No entries yet. The first real entry goes here. Copy this shape:

### L-001 — 2026-08-10 — short title
